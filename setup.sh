...
write_env_value MARKET_FOCUS_LEGACY_RECOVERY_AUTHORIZATIONS "$(setting_or_default MARKET_FOCUS_LEGACY_RECOVERY_AUTHORIZATIONS '[]')"
...
write_env_value ANALYSIS_WORKER_QUICK_CHECK_INTERVAL_SECONDS "$(setting_or_default ANALYSIS_WORKER_QUICK_CHECK_INTERVAL_SECONDS 1800)"
