...
write_env_value NEWS_LLM_MANUAL_DAILY_JOB_LIMIT "$(setting_or_default NEWS_LLM_MANUAL_DAILY_JOB_LIMIT 50)"
write_env_value NEWS_LLM_MANUAL_DAILY_OUTPUT_TOKEN_LIMIT "$(setting_or_default NEWS_LLM_MANUAL_DAILY_OUTPUT_TOKEN_LIMIT 1638400)"
...
write_env_value HOT_CYCLE_MANUAL_ENABLED "$(setting_or_default HOT_CYCLE_MANUAL_ENABLED true)"
